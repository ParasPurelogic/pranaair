...
import PranaSenseDataAccessibilityTab from "@/Components/Pages/PranaSensMonitor/prana-sense-data-accessibility-tab"
import ProductSlider from "@/Components/Pages/PranaSensMonitor/product-slider"
import PranaSenseFaqAccordion from "@/Components/Pages/PranaSensMonitor/prana-sense-faq-accordion"
...
export default function PranaSense() {
    ...
    return (
        <div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="hero-text">
                                ...
                                <a href="#get-in-touch">
                                    Contact Us{" "}
                                    <img src="https://www.pranaair.com/wp-content/uploads/2024/09/download-btn.png" alt="button icon" />
                                </a>
                            </div>
                        </div>
                                    ...
                                    <li>
                                        <h3>
                                            ...
                                            <img
                                                ...
                                                alt="high technology air quality sensors"
                                            />
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            ...
                                            <img
                                                ...
                                                alt="smart calibration for the sensors"
                                            />
                                        </h3>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <h3>
                                            ...
                                            <img
                                                ...
                                                alt="hassle free data connectivity"
                                            />
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            ...
                                            <img
                                                ...
                                                alt="real-time air quality data insights"
                                            />
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            ...
                                            <img
                                                ...
                                                alt="highly accurate air quality data"
                                            />
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            ...
                                            <img
                                                ...
                                                alt="seamless data connectivity wifi and GSM"
                                            />
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            ...
                                            <img
                                                ...
                                                alt="cost effective maintenance"
                                            />
                                        </h3>
                                    </li>
                                </ul>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="gas-monitor-heading">
                                <h2>
                                    Precision Pollutant Detection: <strong>Outdoor Air Quality Monitoring</strong>
                                </h2>
                            </div>
                        </div>
                        <div className="col-md-6"></div>
                        ...
                        <div className="col-12">
                            <div className="pollutant-gas-monitor">
                                <ul>
                                    <li>
                                        <h3>
                                            <img
                                                ...
                                                alt="sensor of Particular Matter PM2.5, PM10, PM1"
                                            />{" "}
                                            Particular Matter (PM1,2.5 & 10)
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <img
                                                ...
                                                alt="sensor of Temperature and Humidity"
                                            />{" "}
                                    ...
                                    <li>
                                        <h3>
                                            <img
                                                ...
                                                alt="sensor of noise monitoring"
                                            />{" "}
                                            Noise Monitoring
                                        </h3>
                                    </li>
                                    ...
                                    <li>
                                        <h3>
                                            <img src="https://www.pranaair.com/wp-content/uploads/2024/09/CO.png" alt="sensor of CO gas" />{" "}
                                            Carbon Monoxide (CO)
                                        </h3>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <h3>
                                            <img
                                                ...
                                                alt="sensor of TVOC odor monitoring"
                                            />{" "}
                                            TVOC Monitoring
                                        </h3>
                                    </li>
                                    <li>
                                        <h3>
                                            <img src="https://www.pranaair.com/wp-content/uploads/2024/09/CO2.png" alt="sensor of CO2 gas" />{" "}
                                            CO₂ Sensing
                                        </h3>
                                    </li>
                                </ul>
                        ...
                        <div className="col-md-6">
                            <div className="power-img">
                                <img
                                    ...
                                    alt="prana sense ambient air quality monitoring device with inbuilt battery"
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="solar-panel-txt">
                                <ul className="solar-box">
                                    ...
                                    <li>
                                        <h4>Solar Panel</h4>
                                        <h5>
                                            30 <span className="watt">Watt</span>
                                        </h5>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <ul className="no-addi-box">
                                    ...
                                    <li>
                                        ...
                                        <p>
                                            Direct connect solar panel to the air quality monitor without additional controllers or
                                            connectors.
                                        </p>
                                    </li>
                                </ul>
                        ...
                        <div className="col-md-6">
                            <div className="waterproof-resistant-txt">
                                <img
                                    ...
                                    alt="Prana Sense is a weatherproof ambient air quality monitor"
                                />
                                <h3>All-Weather Warrior</h3>
                                <p>
                                    Built to Last that stands in every Weather condition and ensures reliable performance in rain,
                                    heatwaves, dust etc.
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="all-weather-monitor-img">
                                <img
                                    ...
                                    alt="Weather resistant ambient air quality monitor"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="weather-data-para">
                                <p>
                                    <strong>Get a complete Environmental overview:</strong> Optional weather station for real-time data
                                ...
                                <ul>
                                    <li className="speed">
                                        <img
                                            ...
                                            alt="measuring wind speed direction"
                                        />
                                    </li>
                                    <li className="chart">
                                        <img
                        ...
                        <div className="col-md-6">
                            <div className="weather-data-img">
                                <img
                                    ...
                                    alt="Prana Sense ambient air quality monitor with weather station monitoring air quality and weather data"
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="smart-feature-box">
                                ...
                                <div className="gps">
                                    <img
                                        ...
                                        alt="Prana Sense with GPS integration to locate exact location"
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="smart-feature-box-display">
                                ...
                                <div className="clear-display">
                                    ...
                                    <img
                                        ...
                                        alt="air quality data display on clear big screen"
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="smart-feature-data">
                                ...
                                <div className="data-storage">
                                    <img
                                        ...
                                        alt="onboard data storage on micro SD card"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row mob-flex">
                            ...
                            <div className="stay-monitor-img">
                                <ul>
                                    <li className="wifi">
                                        <img
                                            ...
                                            alt="wifi connectivity on Prana Sense"
                                        />
                                        Wi-Fi
                                    </li>
                                </ul>
                                <div className="connect-monitor">
                                    <img
                                        ...
                                        alt="Easy data connectivity of Prana Sense Outdoor air quality monitor"
                                    />
                                </div>
                                <ul>
                                    <li className="rs-mod">
                                        <img
                                            ...
                                            alt="RS485 connectivity on Prana Sense"
                                        />
                                        RS485
                                        <span className="rs">(MODBUS)</span>
                                    </li>
                                    <li className="gsm">
                                        <img
                                            src="https://www.pranaair.com/wp-content/uploads/2024/09/GSM.png"
                                            alt="GSM connectivity on Prana Sense"
                                        />
                                        GSM
                                    </li>
                                    <li className="lora">
                                        <img
                                            ...
                                            alt="LoRa connectivity on Prana Sense"
                                        />
                                        LoRa
                                    </li>
                                </ul>
                        ...
                        <div className="col-md-6">
                            <div className="connect-anywhere-txt">
                                ...
                                <p>
                                    Always stay connected and informed with Multi-Mode Connectivity: RS485, WiFi, LoRa, and 4G options in
                                    your Prana Sense.
                                </p>
                            </div>
                        </div>
                                ...
                                <ul className="colar">
                                    <li>
                                        <img
                                            ...
                                            alt="solar power source in Prana Sense ambient air quality monitor"
                                        />
                                        Solar
                                    </li>
                                    <li>
                                        <img
                                            ...
                                            alt="DC power source in Prana Sense ambient air quality monitor"
                                        />
                                        D/C
                                    </li>
                                </ul>
                                <div className="data-ofline">
                                    <div className="data-ofline-img">
                                        <img
                                            ...
                                            alt="Prana Sense Air Quality Monitoring with Advanced Technology"
                                        />
                                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <img
                                                    ...
                                                    alt="data storage in micro SD card in Prana Sense ambient air quality monitor"
                                                />
                                                SD Card
                                            </li>
                                        </ul>
                        ...
                        <div className="col-md-4">
                            <div className="connectivity-heading">
                                ...
                                <div className="connectivity-ofline">
                                    <div className="connectivity-img">
                                        <ul>
                                            ...
                                            <li>
                                                <img src="https://www.pranaair.com/wp-content/uploads/2024/09/GSM.png" alt="GSM connectivity" />
                                                GSM
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="lora-mo">
                                    ...
                                    <ul>
                                        <li>
                                            <img src="https://www.pranaair.com/wp-content/uploads/2024/09/LoRa.png" alt="LoRa connectivity" />
                                            LoRa
                                        </li>
                                        <li>
                                            <img
                                                src="https://www.pranaair.com/wp-content/uploads/2024/09/RS485.png"
                                                alt="RS485 connectivity"
                                            />
                                            RS485
                                            <span className="rs-mod">(MODBUS)</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul className="app">
                                <li>
                                    <img
                                        ...
                                        alt="data connectivity on AQI mobile app"
                                    />
                                ...
                                <li>
                                    <img
                                        ...
                                        alt="air quality data accessibility on AQI web-dashboard"
                                    />
                                ...
                                <li>
                                    <img
                                        ...
                                        alt="air quality data accessibility on AQI TV app"
                                    />
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="noise-para">
                                <p>
                                    Prana Sense Monitor noise levels from 30 to 130 dB with 1 dB accuracy, ensuring precise acoustic
                                    measurements.
                                </p>
                            </div>
                        </div>
            ...
            <PranaSenseDataAccessibilityTab />
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="sensor-heading">
                            ...
                            <h3>
                                <strong>Double</strong> the Sensors, <strong>Double</strong> the Security
                            </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="sensor-para">
                                <p>
                                    The advanced technology of <strong>dual sensors</strong> in our monitors safeguards against possible
                                    sensor failure.
                                </p>
                                <p>
                                    Also <strong>ensures continuous monitoring with zero downtime</strong>. It offers a faster response
                                    time in any discrepancies and is also a reliable option to tackle the situation.
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="sensor-img">
                                <img
                                    ...
                                    alt="highly accurate and advanced air quality sensors in Prana Sense Monitor"
                                />
                                <ul>
                                    <li>
                                        <span className="green">1</span>Primary sensor
                                    </li>
                                    <li>
                                        <span className="yellow">1</span>Reserve sensor
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-md-7">
                            <div className="sensor-data-img">
                                <img
                                    ...
                                    alt="chart showing air quality sensor Data Aligned"
                                />
                            </div>
                        </div>
                        <div className="col-md-5">
                            <div className="sensor-data-para">
                                ...
                                <p>
                                    Dual sensor technology to ensure continuous PM monitoring. The primary and reserve sensors data are
                                    aligning. Thus, the reserve sensor goes on the sleep mode.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="row mob-flex">
                        <div className="col-md-5">
                            <div className="sensor-data-para">
                                ...
                                <p>
                                    The data of primary sensor and reserve sensor not aligned. Hence the reserve sensor takes over the
                                    function on Primary sensor without changing.
                                </p>
                            </div>
                        </div>
                        <div className="col-md-7">
                            <div className="sensor-data-img">
                                <img
                                    ...
                                    alt="chart showing air quality sensor Data Not Aligned"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row mid-box mob-scroll">
                        <div className="col-md-6">
                            <div className="product-specifi">
                                Product Name :<h4>Prana Sense</h4>
                            </div>
                        ...
                        <div className="col-md-6">
                            <div className="product-specifi">
                                Battery working hours :<h4>96hrs</h4>
                            </div>
                            <div className="product-specifi shdw-line">
                                Battery capacity:
                                <h4>40,000mAh</h4>
