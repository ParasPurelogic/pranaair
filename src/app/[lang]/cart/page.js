      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl" style={{ marginTop: "80px" }}>
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-600 mb-8">Looks like you havent added any products to your cart yet.</p>
            <Link
              href="/"
          ...
          <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="flex">
              ...
              <button
                ...
                className={`px-4 py-2 font-medium rounded-r-md ${couponApplied ? "bg-gray-300 text-gray-700" : "bg-green-500 hover:bg-green-600 text-white"
                  }`}
                disabled={couponApplied}
              >
