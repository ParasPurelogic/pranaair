          ...
          {activeTab === "dashboard" && (
            <div className="account-dashboard">
              ...
              <p className="welcome-message">
                Welcome back {profile.firstName}! Heres a summary of your recent activities.
              </p>
            ...
            <div className="account-addresses">
              ...
              {addresses.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>You havent added any addresses yet.</p>
            ...
            <div className="account-payments">
              ...
              {paymentMethods.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>You havent added any payment methods yet.</p>
                  <button className="btn-primary">
                    <Plus size={16} />
