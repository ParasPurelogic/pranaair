            ...
            >
              <div className="solution-card">
                ...
                <div className="solution-content">
                  ...
                  <Link className="secondary-button" href={`${domain}/air-quality-monitor/sensible-plus-air-monitor`}>
            ...
            >
              <div className="solution-card">
                ...
                <div className="solution-content">
                  ...
                  <Link className="secondary-button" href={`${domain}/fresh-air-machine`}>
