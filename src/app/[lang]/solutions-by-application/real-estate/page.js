                    ...
                    <div className="carousel-item">
                      <div className="product-slide">
                        <div className="product-info">
                          ...
                          <div className="product-actions">
                            <Link
                              href={`${domain}/air-quality-monitor/squair-air-monitor/sensible-plus-air-monitor/`}
                              className="primary-button"
                            >
                              {t("realEstateSolutions.knowMore")}
                            </Link>
                            <Link
                              href={`${domain}/air-quality-monitor/rental-air-monitor/squair-air-monitor/sensible-plus-air-monitor/`}
